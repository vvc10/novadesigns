    ...
    <section id="contact" className="section-padding relative overflow-hidden">
      ...
      <div className="grid-container relative z-10">
        <SectionHeading
          ...
          subtitle="Ready to start your next project? Get in touch with us to discuss how we can help bring your vision to life."
        />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="mb-8">
              We're always looking for new challenges and exciting projects. Whether you have a specific project in mind or just want to explore possibilities, we'd love to hear from you.
            </p>
